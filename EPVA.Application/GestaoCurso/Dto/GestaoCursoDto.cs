...
{
    public record ModuloInputDto(string Nome, List<AulaInputDto> Aulas, List<ClasseInputDto> Classes);
    public record ModuloOutputDto(Guid Id, string Nome, List<AulaOutputDto> Aulas, List<MaterialOutputDto> Materiais, List<ClasseOutputDto> Classes);
